        ...
        <el-form class="clearfix" ref="formData" :model="formData" label-width="120px" v-loading.body="loading">
            ...
            <el-col :span="4">
                <el-form-item label="过户单号">
                    <el-input style="width: 100%" v-model="formData.no" placeholder="请输入过户单号"></el-input>
                </el-form-item>
            </el-col>
            <el-col :span="4">
            ...
            <el-col :span="4">
                <el-form-item label-width="120px" label="过户开始时间">
                    <el-date-picker style="width: 100%" v-model="formData.timeStart" type="date" placeholder="选择日期">
                    </el-date-picker>
                </el-form-item>
            </el-col>
            <el-col :span="4">
                <el-form-item label-width="120px" label="过户结束时间">
